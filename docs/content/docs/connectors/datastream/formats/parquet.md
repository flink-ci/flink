...
Following example uses the example schema [testdata.avsc](https://github.com/apache/flink/blob/master/flink-formats/flink-parquet/src/test/resources/avro/testdata.avsc):
...
Following example shows the User schema used previously. But this time it contains a namespace 
