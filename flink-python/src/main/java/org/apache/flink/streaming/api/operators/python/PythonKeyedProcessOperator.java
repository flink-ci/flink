...
public class PythonKeyedProcessOperator<OUT>
    ...
    private static final Logger LOG = LoggerFactory.getLogger(PythonKeyedProcessOperator.class);
    ...
    public void emitResult(Tuple2<byte[], Integer> resultTuple) throws Exception {
        ...
        ByteArrayInputStreamWithPos bais2 = new ByteArrayInputStreamWithPos();
        DataInputViewStreamWrapper baisWrapper2 = new DataInputViewStreamWrapper(bais2);
        bais2.setBuffer(rawResult, 0, length);
        Row runnerOutput = runnerOutputSerializer.deserialize(baisWrapper2);
