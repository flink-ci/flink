...
public class ParquetFilters {
    ...
    private Tuple2<Column<?>, Comparable<?>> getColumnLiteralPair(
        ...
        Comparable<?> literal = castLiteral(litType, literalValue);
        if (literal == null) {
            return null;
        }
    ...
    private Comparable<?> castTo(Comparable<?> literal, Column<?> column) {
        // xxx
        return null;
    }
     ...
     *
     * @param litType the data type of the column
    ...
    private Comparable<?> castLiteral(DataType litType, Object literal) {
        ...
        switch (ltype) {
            ...
            default:
                LOG.warn("Can't cast literal to data type {} in parquet format.", ltype);
                return null;
        }
    }
