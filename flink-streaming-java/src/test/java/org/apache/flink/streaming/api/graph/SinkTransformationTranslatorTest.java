...
public class SinkTransformationTranslatorTest extends TestLogger {
    ...
    @Parameterized.Parameters(
            name =
                    "Execution Mode: {0}, Expected Committer Operator: {1}, Expected Global Committer Operator: {2}")
                ...
                new Object[][] {
                    {
                        ...
                        StreamingGlobalCommitterOperatorFactory.class
                    },
                    {
                        RuntimeExecutionMode.BATCH,
                        BatchCommitterOperatorFactory.class,
                        BatchGlobalCommitterOperatorFactory.class
                    }
                });
    }
    ...
    public void generateWriterTopology() {
        final StreamGraph streamGraph = buildGraph(Test.newBuilder().build(), runtimeExecutionMode);
    ...
    public void generateWriterCommitterTopology() {
        ...
        final StreamGraph streamGraph =
                buildGraph(Test.newBuilder().setDefaultCommitter().build(), runtimeExecutionMode);
    ...
    public void generateWriterCommitterGlobalCommitterTopology() {
        ...
        final StreamGraph streamGraph =
                buildGraph(
                        Test.newBuilder().setDefaultCommitter().setDefaultGlobalCommitter().build(),
    ...
    public void throwExceptionWithoutSettingUid() {
        ...
        env.fromElements(1, 2).sinkTo(Test.newBuilder().build());
        env.getStreamGraph();
    }
    ...
    public void disableOperatorChain() {
        ...
        assertThat(
                committer.getOperatorFactory().getChainingStrategy(), is(ChainingStrategy.ALWAYS));
        assertThat(
    ...
    private void validateTopology(
        ...
        assertThat(dest.getOperatorFactory(), instanceOf(expectedOperatorFactory));
    ...
    private StreamGraph buildGraph(Test sink, RuntimeExecutionMode runtimeExecutionMode) {
        StreamExecutionEnvironment env = StreamExecutionEnvironment.getExecutionEnvironment();
