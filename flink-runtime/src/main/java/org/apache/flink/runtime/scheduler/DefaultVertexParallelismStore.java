...
public class DefaultVertexParallelismStore implements MutableVertexParallelismStore {
    ...
    @Override
    public void setParallelismInfo(JobVertexID jobVertexId, VertexParallelismInformation info) {
        vertexToParallelismInfo.put(jobVertexId, info);
    }

    @Override
    public Optional<VertexParallelismInformation> getParallelismInfo(JobVertexID vertexId) {
