...
public interface VertexParallelismStore {
    /**
     * Returns a given vertex's parallelism information, if present.
     *
     * @param vertexId vertex for which the parallelism information should be returned
     * @return an optional parallelism information for the given vertex
     */
    Optional<VertexParallelismInformation> getParallelismInfo(JobVertexID vertexId);
}
